...
public class ListViewActivity extends AppCompatActivity {
    ...
    class ImageListAdapter extends ArrayAdapter {
        ...
        public ImageListAdapter(Context context, String[] imageUrls) {
            super(context, R.layout.item_demo, imageUrls);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (null == convertView) {
                ...
                viewHolder.imageView = (ImageView) convertView.findViewById(R.id.item_demo_iv);
                viewHolder.textView = (TextView) convertView.findViewById(R.id.item_demo_tv);
                convertView.setTag(viewHolder);
            } else {
                viewHolder = (ViewHolder) convertView.getTag();
            }
            viewHolder.textView.setText(imageUrls[position]);
            Glide.with(context)
                    .load(imageUrls[position]).placeholder(R.mipmap.ic_launcher).crossFade().centerCrop().fitCenter().thumbnail(.1f)
