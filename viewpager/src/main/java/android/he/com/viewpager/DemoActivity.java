...
public class DemoActivity extends Activity implements AdapterView.OnItemClickListener, ViewPager.OnPageChangeListener, OnItemClickListener {
    private ConvenientBanner convenientBanner;//顶部广告栏控件
    private ConvenientBanner convenientBanner1;//顶部广告栏控件
...
//        //各种翻页效果
    ...
    protected void onResume() {
        ...
        convenientBanner1.startTurning(2000);
    }
...
//        convenientBanner.setCanLoop(!convenientBanner.isCanLoop());
        ...
        try {
            ...
            convenientBanner1.getViewPager().setPageTransformer(true, transforemer);

            //部分3D特效需要调整滑动速度
            if (transforemerName.equals("StackTransformer")) {
                convenientBanner.setScrollDuration(1200);
                convenientBanner1.setScrollDuration(1200);
            }
